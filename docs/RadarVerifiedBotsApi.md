...
------------- | ------------- | -------------
[**radarGetHttpTopVerifiedBotCategories**](RadarVerifiedBotsApi.md#radarGetHttpTopVerifiedBotCategories) | **GET** /radar/verified_bots/top/categories | Get top verified bot categories by HTTP requests
[**radarGetHttpTopVerifiedBots**](RadarVerifiedBotsApi.md#radarGetHttpTopVerifiedBots) | **GET** /radar/verified_bots/top/bots | Get top verified bots by HTTP requests

<a name="radarGetHttpTopVerifiedBotCategories"></a>
# **radarGetHttpTopVerifiedBotCategories**
> InlineResponse200103 radarGetHttpTopVerifiedBotCategories(limit, name, dateRange, dateStart, dateEnd, asn, location, format)
...
//import io.swagger.client.api.RadarVerifiedBotsApi;
...
RadarVerifiedBotsApi apiInstance = new RadarVerifiedBotsApi();
...
try {
    InlineResponse200103 result = apiInstance.radarGetHttpTopVerifiedBotCategories(limit, name, dateRange, dateStart, dateEnd, asn, location, format);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling RadarVerifiedBotsApi#radarGetHttpTopVerifiedBotCategories");
    e.printStackTrace();
}
```
...
<a name="radarGetHttpTopVerifiedBots"></a>
# **radarGetHttpTopVerifiedBots**
> InlineResponse200102 radarGetHttpTopVerifiedBots(limit, name, dateRange, dateStart, dateEnd, asn, location, format)
...
String format = "format_example"; // String | Format results are returned in.
try {
    InlineResponse200102 result = apiInstance.radarGetHttpTopVerifiedBots(limit, name, dateRange, dateStart, dateEnd, asn, location, format);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling RadarVerifiedBotsApi#radarGetHttpTopVerifiedBots");
    e.printStackTrace();
}
```
