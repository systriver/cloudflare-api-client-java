...
public class EventDetailsResult {
  ...
  public EventDetailsResult createdOn(OffsetDateTime createdOn) {
  ...
  **/
  ...
  public EventDetailsResult customPageHtml(String customPageHtml) {
  ...
  **/
  ...
  public EventDetailsResult description(String description) {
  ...
  **/
  ...
  public EventDetailsResult disableSessionRenewal(Boolean disableSessionRenewal) {
  ...
  **/
  ...
  public EventDetailsResult eventEndTime(String eventEndTime) {
  ...
  **/
  ...
  public EventDetailsResult eventStartTime(String eventStartTime) {
  ...
  **/
  ...
  public EventDetailsResult id(EventId id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EventDetailsResult modifiedOn(OffsetDateTime modifiedOn) {
  ...
  **/
  ...
  public EventDetailsResult name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public EventDetailsResult newUsersPerMinute(Integer newUsersPerMinute) {
  ...
  **/
  ...
  public EventDetailsResult prequeueStartTime(String prequeueStartTime) {
  ...
  **/
  ...
  public EventDetailsResult queueingMethod(String queueingMethod) {
  ...
  **/
  ...
  public EventDetailsResult sessionDuration(Integer sessionDuration) {
  ...
  **/
  ...
  public EventDetailsResult shuffleAtEventStart(Boolean shuffleAtEventStart) {
  ...
  **/
  ...
  public EventDetailsResult suspended(Boolean suspended) {
  ...
  **/
  ...
  public EventDetailsResult totalActiveUsers(Integer totalActiveUsers) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EventDetailsResult eventDetailsResult = (EventDetailsResult) o;
    return Objects.equals(this.createdOn, eventDetailsResult.createdOn) &&
        Objects.equals(this.customPageHtml, eventDetailsResult.customPageHtml) &&
        Objects.equals(this.description, eventDetailsResult.description) &&
        Objects.equals(this.disableSessionRenewal, eventDetailsResult.disableSessionRenewal) &&
        Objects.equals(this.eventEndTime, eventDetailsResult.eventEndTime) &&
        Objects.equals(this.eventStartTime, eventDetailsResult.eventStartTime) &&
        Objects.equals(this.id, eventDetailsResult.id) &&
        Objects.equals(this.modifiedOn, eventDetailsResult.modifiedOn) &&
        Objects.equals(this.name, eventDetailsResult.name) &&
        Objects.equals(this.newUsersPerMinute, eventDetailsResult.newUsersPerMinute) &&
        Objects.equals(this.prequeueStartTime, eventDetailsResult.prequeueStartTime) &&
        Objects.equals(this.queueingMethod, eventDetailsResult.queueingMethod) &&
        Objects.equals(this.sessionDuration, eventDetailsResult.sessionDuration) &&
        Objects.equals(this.shuffleAtEventStart, eventDetailsResult.shuffleAtEventStart) &&
        Objects.equals(this.suspended, eventDetailsResult.suspended) &&
        Objects.equals(this.totalActiveUsers, eventDetailsResult.totalActiveUsers);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventDetailsResult {\n");
