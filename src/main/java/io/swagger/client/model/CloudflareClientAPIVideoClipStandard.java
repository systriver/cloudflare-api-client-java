...
public class CloudflareClientAPIVideoClipStandard {
  ...
  public CloudflareClientAPIVideoClipStandard allowedOrigins(AllowedOrigins allowedOrigins) {
  ...
  **/
  ...
  public CloudflareClientAPIVideoClipStandard clippedFromVideoUID(String clippedFromVideoUID) {
  ...
  **/
  ...
  public CloudflareClientAPIVideoClipStandard creator(String creator) {
  ...
  **/
  ...
  public CloudflareClientAPIVideoClipStandard endTimeSeconds(Integer endTimeSeconds) {
  ...
  **/
  ...
  public CloudflareClientAPIVideoClipStandard maxDurationSeconds(Integer maxDurationSeconds) {
  ...
  **/
  ...
  public CloudflareClientAPIVideoClipStandard requireSignedURLs(Boolean requireSignedURLs) {
  ...
  **/
  ...
  public CloudflareClientAPIVideoClipStandard startTimeSeconds(Integer startTimeSeconds) {
  ...
  **/
  ...
  public CloudflareClientAPIVideoClipStandard thumbnailTimestampPct(BigDecimal thumbnailTimestampPct) {
  ...
  **/
  ...
  public CloudflareClientAPIVideoClipStandard watermark(WatermarkAtUpload watermark) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CloudflareClientAPIVideoClipStandard cloudflareClientAPIVideoClipStandard = (CloudflareClientAPIVideoClipStandard) o;
    return Objects.equals(this.allowedOrigins, cloudflareClientAPIVideoClipStandard.allowedOrigins) &&
        Objects.equals(this.clippedFromVideoUID, cloudflareClientAPIVideoClipStandard.clippedFromVideoUID) &&
        Objects.equals(this.creator, cloudflareClientAPIVideoClipStandard.creator) &&
        Objects.equals(this.endTimeSeconds, cloudflareClientAPIVideoClipStandard.endTimeSeconds) &&
        Objects.equals(this.maxDurationSeconds, cloudflareClientAPIVideoClipStandard.maxDurationSeconds) &&
        Objects.equals(this.requireSignedURLs, cloudflareClientAPIVideoClipStandard.requireSignedURLs) &&
        Objects.equals(this.startTimeSeconds, cloudflareClientAPIVideoClipStandard.startTimeSeconds) &&
        Objects.equals(this.thumbnailTimestampPct, cloudflareClientAPIVideoClipStandard.thumbnailTimestampPct) &&
        Objects.equals(this.watermark, cloudflareClientAPIVideoClipStandard.watermark);
  }
  ...
  public String toString() {
    ...
    sb.append("class CloudflareClientAPIVideoClipStandard {\n");
