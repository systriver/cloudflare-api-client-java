...
import io.swagger.client.model.InlineResponse4xx529;
...
public class SingleRedirectRulesApiTest {
     ...
     */
    @Test
    public void singleRedirectRulesListSingleRedirectRulesTest() throws Exception {
        String zoneId = null;
        ComponentsSchemasRuleset response = api.singleRedirectRulesListSingleRedirectRules(zoneId);
     ...
     */
    @Test
    public void singleRedirectRulesUpdateSingleRedirectRulesTest() throws Exception {
        UpdateRuleset body = null;
        String zoneId = null;
        ApiResponseSingle response = api.singleRedirectRulesUpdateSingleRedirectRules(body, zoneId);
